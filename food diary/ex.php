...
<div class="container">
        ...
        <div class="meal-section">
            <h3>Breakfast</h3>
<span class="add-food" onclick="openFoodSearch()">Add Food</span>
            <div class="dropdown">
...
function fetchFoodEntries(date) {
    ...
    function displayFoodEntries(entries) {
        ...
        function updateTotals(dailyGoals) {
...
window.onload = function() {
    const dailyGoals = {
        calories: <?php echo $daily_goals['calories']; ?>,
        carbs: <?php echo $daily_goals['carbs']; ?>,
        fat: <?php echo $daily_goals['fat']; ?>,
        protein: <?php echo $daily_goals['protein']; ?>,
        sodium: <?php echo $daily_goals['sodium']; ?>,
        sugar: <?php echo $daily_goals['sugar']; ?>
    };
    updateTotals(dailyGoals);  /
};
...
function completeEntry() {
    ...
    .then(data => {
        if (data.status === 'success') {
            ...
            document.querySelector('.complete-entry').style.display = 'none'; 
        } else {
